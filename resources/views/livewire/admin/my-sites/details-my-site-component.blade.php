                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4" style="border: 1px solid #e9e9e9; padding: 35px 15px;">
                                    <h3 style="text-align: center;" class="mb-4"><i style="color: green;" class="bx bxs-up-arrow-circle"></i>Performance</h3>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <p style="text-align: center;" class="text-muted">We're monitoring the performance of your site. Your site is fast. We last checked 8 minutes ago.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4" style="border: 1px solid #e9e9e9; padding: 35px 15px;">
                                    <h3 style="text-align: center;" class="mb-4"><i style="color: green;" class="bx bxs-up-arrow-circle"></i>Certificate health</h3>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <p style="text-align: center;" class="text-muted">Your site is up. We last checked less than a minute ago.</p>
                                ...
                                <div class="col-md-4" style="border: 1px solid #e9e9e9; padding: 35px 15px;">
                                    <h3 style="text-align: center;" class="mb-4"><i style="color: green;" class="bx bxs-up-arrow-circle"></i>Domain</h3>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <p style="text-align: center;" class="text-muted">Your domain seems to be ok. We last checked 1 hour ago.</p>
                                            <h5 style="text-align: center;">EXPIRES IN 2 months from now</h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4" style="border: 1px solid #e9e9e9; padding: 35px 15px;">
                                    <h3 style="text-align: center;" class="mb-4"><i style="color: green;" class="bx bxs-up-arrow-circle"></i>Certificate Issuer</h3>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <p style="text-align: center;" class="text-muted">Your site is up. We last checked less than a minute ago.</p>
                                        </div>
                                ...
                                <div class="col-md-4" style="border: 1px solid #e9e9e9; padding: 35px 15px;">
                                    <h3 style="text-align: center;" class="mb-4"><i style="color: green;" class="bx bxs-up-arrow-circle"></i>Last Check Time</h3>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <p style="text-align: center;" class="text-muted">Your site is up. We last checked less than a minute ago.</p>
                                        </div>
