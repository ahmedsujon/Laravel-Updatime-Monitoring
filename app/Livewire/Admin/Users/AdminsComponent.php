...
class AdminsComponent extends Component
{
    ...
    public function storeData()
    {
        ...
        $this->dispatchBrowserEvent('success', ['message' => 'New admin added successfully']);
        $this->resetInputs();
    }
    ...
    public function updateData()
    {
        ...
        $this->dispatchBrowserEvent('closeModal');
        $this->dispatchBrowserEvent('success', ['message' => 'Admin updated successfully']);
        $this->resetInputs();
    }
    ...
    public function deleteData()
    {
        ...
        $admin->delete();
        $this->dispatchBrowserEvent('admin_deleted');
        $this->delete_id = '';
    }
    ...
    public function render()
    {
        ...
        $this->dispatchBrowserEvent('reload_scripts');
